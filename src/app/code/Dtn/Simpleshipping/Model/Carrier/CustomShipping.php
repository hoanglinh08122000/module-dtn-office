...
namespace Dtn\Simpleshipping\Model\Carrier;
    ...
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    ...
    public function collectRates(RateRequest $request)
    {
         ...
         * Get price freeship
         */
        $freeshipping = $this->getConfigData('freeshipping');
        ...
        if ($total > $freeshipping) {
            ...
            $pay = $amount;
//            $buymore = ($freeshipping - $total);
//            $pay = 'Mua them '.$buymore.' de duong free ship';
        }
